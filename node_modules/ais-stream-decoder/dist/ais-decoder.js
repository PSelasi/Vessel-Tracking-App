...
const ais_message_8_1 = __importDefault(require("./messages/ais-message-8"));
    ...
    handleMultiPartSentence(sentence) {
        ...
        if (sentence.isLastPart()) {
            if (this.multiPartBuffer.length !== sentence.numParts) {
                ...
                throw new errors_1.DecodingError('Incorrect multipart order', sentence.message);
            }
            const payloads = this.multiPartBuffer.map(multiPartSentence => multiPartSentence.payload);
            this.decodePayload(payloads.join(''), sentence.channel, this.multiPartBuffer);
            this.multiPartBuffer.length = 0;
        }
    }
    ...
    decodePayload(payload, channel, sentences) {
        ...
        switch (messageType) {
            ...
            case 5:
                ...
                break;
            case 8:
                decodedMessage = new ais_message_8_1.default(messageType, channel, bitField);
                break;
            case 18:
